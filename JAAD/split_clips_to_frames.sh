...
CLIPS_DIR=/Users/thomasriedel/Benchmark_PedIntPred/JAAD/JAAD_clips  #path to the directory with mp4 videos
FRAMES_DIR=/Volumes/T7/PIE/images  #path to the directory for frames
