...
def main(args):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename='jaad-{epoch:02d}-{val_acc:.3f}', save_weights_only=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--logdir', type=str, default="./data/jaad/tb/", help="logger directory for tensorboard")
