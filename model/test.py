...
def main(args):
    ...
    # Load Dataset 
    test_data = []
    tr_data = DataSet(path=args.data_path, data_type='pie', data_set='train', balance=False, bbox=args.bbox, velocity=args.velocity)
    #Start time
    start = time.time()
    #te_data_jaad = DataSet(path=args.data_path, data_type='jaad', data_set='test', balance=False, bbox=args.bbox, velocity=args.velocity)
    te_data = DataSet(path=args.data_path, data_type='jaad', data_set='test', balance=False, bbox=args.bbox, velocity=args.velocity)
    #te_data = DataSet(path=args.data_path, data_type='pie', data_set='test', balance=False, bbox=args.bbox, velocity=args.velocity)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--velocity', type=bool, default=False, help='activate the use of the gps velocity')
